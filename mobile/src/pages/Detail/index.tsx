...
const Detail = () =>{
  ...
  function handleWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=${data.serializedPoint.whatsapp}&text= Tenho interesse sobre coleta de residuos`)
  }
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.address}>
                    <Text style={styles.addressTitle}>Endereco tal</Text>
