...
import { StyleSheet, View, Text, Image, ImageBackground, KeyboardAvoidingView, Platform , TextInput} from 'react-native';
...
const Home = () => {
    ...
    const [selecteCity,setSelectedCity] = useState('0');
